...
void CA_load_cmd_table(CA_CmdInfo cmd_table[CA_MAX_CMDS])
{
  ...
  cmd_table[Cmd_CODE_TLCD_SET_LINE_NO_FOR_TIMELINE_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  ...
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HK_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HK_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HK_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_SYSTEM_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_SYSTEM_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_SYSTEM_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HIGH_FREQ_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HIGH_FREQ_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_HIGH_FREQ_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_LOW_FREQ_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TLM_MGR_REGISTER_LOW_FREQ_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
